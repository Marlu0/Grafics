...
void main()
{
	...
	float vignette_factor = smoothstep(0.4, 0.7, distance);  // Adjust these values for the vignette's spread

    vec4 final_color = texture_color * (1.0 - vignette_factor * u_vignette_strength);
