...
public:
    ...
    void DrawOctant(int xc, int yc, int x, int y, const Color& c);
    void DrawCircle(int xc, int yc, int r, const Color& borderColor, int borderWidth, bool isFilled, const Color& fillColor);
    void FillCircle(int xc, int yc, int r, const Color& fillColor);
